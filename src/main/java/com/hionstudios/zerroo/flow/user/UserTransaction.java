...
public class UserTransaction {
    ...
    public MapResponse profile() {
        ...
        if (UserUtil.isDistributor()) {
            sql = "Select Users.Firstname, Users.Lastname, Users.Username, Users.Phone, Users.Email, Users.Gender, Users.Address_1, Users.Address_2, Users.Landmark, Users.Postcode, Users.City, Users.State, Users.Nominee_name, Users.Nominee_relation, To_Char(To_Timestamp(Users.Dob/1000) at Time Zone 'Asia/Kolkata', 'YYYY-MM-DD') Dob, Distributors.Email_Verified, Distributors.Phone_Verified, Kyc_Verification_Statuses.Status Kyc_Status, Distributors.Kyc_Rejection_Reason, Distributors.Kyc_Verification_Id, Bank_Verification_Statuses.Status Bank_Status, Distributors.Bank_Rejection_Reason, Distributors.Bank_Verification_Id, Users.Avatar From Users Join Distributors On Distributors.Id = Users.Id Left Join Kyc_Verification_Statuses On Kyc_Verification_Statuses.Id = Distributors.Kyc_Status_Id Left Join Bank_Verification_Statuses On Bank_Verification_Statuses.Id = Distributors.Bank_Status_Id Where Users.Id = ?";
        } else {
