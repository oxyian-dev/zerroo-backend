...
public class AdminUserTransaction {
    ...
    public MapResponse viewDistributors(DataGridParams params) {
        ...
        String sql = "Select Users.Id, Users.Id \"Action\", Users.Username ZID, Users.Firstname, Distributors.Active, Distributors.Self_Pv \"Self PV\", Distributors.Sp_Pv \"Sp PV\", Ranks.Rank, (Select Coalesce(Sum(Income_Wallet_Transactions.Actual_Amount), 0) From Income_Wallet_Transactions Where Income_Wallet_Transactions.Distributor_Id = Distributors.Id) \"Income Wallet\", Distributors.Purchase_Wallet \"Purchase Wallet\", Distributors.Referer_Id \"Referer Id\",Distributors.Cutoff_Left_PV \"Cutoff Left Pv\", Distributors.Cutoff_Right_Pv \"Cutoff Right Pv\", Distributors.Carry_Left_Pv \"Backup Left Pv\", Distributors.Carry_Right_Pv \"Backup Right Pv\", Distributors.Total_Left_Pv \"Total Left Pv\", Distributors.Total_Right_Pv \"Total Right Pv\", (Select Coalesce(Sum(Income_Wallet_Transactions.Full_Amount), 0) From Income_Wallet_Transactions Join Income_Wallet_Transaction_Types On Income_Wallet_Transaction_Types.Id = Income_Wallet_Transactions.Type_Id And Income_Wallet_Transaction_Types.Type In ('Qualification Income', 'Pair Match Income', 'Sp Income', 'Company') Where Income_Wallet_Transactions.Distributor_Id = Distributors.Id) \"Total Earnings\", (Select Coalesce(Sum(Income_Wallet_Transactions.Full_Amount), 0) From Income_Wallet_Transactions Join Income_Wallet_Transaction_Types On Income_Wallet_Transaction_Types.Id = Income_Wallet_Transactions.Type_Id And Income_Wallet_Transaction_Types.Type = 'Qualification Income' Where Income_Wallet_Transactions.Distributor_Id = Distributors.Id) \"Qualification Income\", (Select Coalesce(Sum(Income_Wallet_Transactions.Full_Amount), 0) From Income_Wallet_Transactions Join Income_Wallet_Transaction_Types On Income_Wallet_Transaction_Types.Id = Income_Wallet_Transactions.Type_Id And Income_Wallet_Transaction_Types.Type = 'Pair Match Income' Where Income_Wallet_Transactions.Distributor_Id = Distributors.Id) \"Pairmatch Income\", (Select Coalesce(Sum(Income_Wallet_Transactions.Full_Amount), 0) From Income_Wallet_Transactions Join Income_Wallet_Transaction_Types On Income_Wallet_Transaction_Types.Id = Income_Wallet_Transactions.Type_Id And Income_Wallet_Transaction_Types.Type = 'Sp Income' Where Income_Wallet_Transactions.Distributor_Id = Distributors.Id) \"Sp Income\", Distributors.Parent_Id \"Immediate Upline Id No\", Kyc_Verifications.Aadhaar \"Aadhar Number\", Kyc_Verifications.Pan \"Pan Number\", Bank_Verifications.Account_No \"Bank Account\" , Bank_Verifications.Ifsc \"IFSc Code\", Users.Phone, Users.Email, Users.Created_Time \"Created Time\", Kyc_Verification_Statuses.Status \"Kyc Status\" From Users Join Distributors On Distributors.Id = Users.Id Join User_Types On User_Types.Id = Users.Type_Id Left Join Ranks On Ranks.Id = Distributors.Rank_Id Left join Kyc_Verification_Statuses On Kyc_Verification_Statuses.Id = Distributors.Kyc_Status_Id Left Join Kyc_Verifications On Distributors.Kyc_Verification_Id = Kyc_Verifications.Id Left Join Bank_Verifications On Distributors.Bank_Verification_Id = Bank_Verifications.Id";
    ...
    public MapResponse deleteDistributor(long id) {
        ...
        PurchaseWalletRequest.delete("Distributor_Id = ?", id);
        DistributorHistory.delete("Distributor_Id = ?", id);
        DistributorRank.delete("Distributor_Id = ?", id);
        PayoutEntry.delete("Distributor_Id = ?", id);
        CutoffEntry.delete("Distributor_Id = ?", id);
        Address.delete("Distributor_Id = ?", id);
        Cart.delete("User_Id = ?", id);
        Login.delete("User_Id = ?", id);
        Otp.delete("Distributor_Id = ?", id);
        UserRole.delete("User_Id = ?", id);
